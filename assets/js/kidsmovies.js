...
const popularMoviesUrl = baseUrl + "/discover/movie?certification_country=US&certification.lte=G&sort_by=popularity.desc&" + apiKey;
...
form.addEventListener('submit', (e) => {
    ...
    if (searchValue) {
        ...
        msgDiv.innerHTML = `<h3>No Results Found</h3>`;
